...
@section('page-content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Danh mục truyện</h6>
        </div>
        <div class="card-body ">
                        ...
                        <div class="dataTables_length" id="dataTable_length">
                           <form action="" class="form-inline" method="GET">
                            <label>
                                ...
                                {{-- <select name="valuePaginate" id="valuePaginate"
                        ...
                        <table class="table table-hover text-nowrap" id="dataTable" width="100%"  cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center; width: 25%">Tên danh mục</th>
                            ...
                            <tbody>
                                @foreach ($data as $value)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <a href="{{ route('category.edit',['category'=>$value->id]) }}">
                                            ...
                                            <a href="" data-url="{{ route('category.destroy',['category'=>$value->id]) }}" class="text-danger w-4 h-4 mr-1 actionDelete" id="actionDelete">
