                ...
                <table class="table table-hover text-nowrap" id="dataTable" width="100%"  cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; ">Thuộc truyện</th>
                    ...
                    <tbody>
                        @foreach ($chapters as $value)
                            <tr>
                                ...
                                <td style="text-align: center">{{ $value->story->name }}</td>
                                ...
                                <td style="text-align: center">
                                    <a href="{{ route('chapter.edit',['chapter'=>$value->id]) }}">
                                    ...
                                    <a href="" data-url="{{ route('chapter.destroy',['chapter'=>$value->id]) }}" class="text-danger w-4 h-4 mr-1 actionDelete" id="actionDelete">
